...
public class orderController {
    ...
    public String dt1,dt2;
     public boolean addOrder(List<order> orders,ActionType at) throws ClassNotFoundException, SQLException{
        sqldb=new SQLDB();
        
         switch(at){
             case ORDER:
                   for(order o:orders){
                        String query="INSERT INTO t_commands(idfood,qte,amount,idinvoice,iduser) VALUES('"+o.getFoood().getIdFood()+"','"+o.getQuantity()+"','"+o.getAmount()+"','"+o.getInvoice()+"','"+loginController._idUser+"')";
             ...
             case BOOKING:
                   for(order o:orders){
                    String query="INSERT INTO t_commands_booking(idfood,qte,amount,idinvoice,iduser) VALUES('"+o.getFoood().getIdFood()+"','"+o.getQuantity()+"','"+o.getAmount()+"','"+o.getInvoice()+"','"+loginController._idUser+"')";
                    int i=sqldb.setQueryUpdate(query);
     ...
     public List<order> getOrdersBilling(OrderBillingEnum obe) throws ClassNotFoundException, SQLException{
      ...
      public List<order> getBookingsBilling(OrderBillingEnum obe) throws ClassNotFoundException, SQLException{
         List<order>Orders=new LinkedList<>();
         String query="";
         LocalDate ld=LocalDate.now();
         String daily=ld.getYear()+"-"+ld.getMonthValue()+"-"+ld.getDayOfMonth();
        ...
        public List<Map<String,Object>>getOrdeToCancel(int code) throws ClassNotFoundException, SQLException{
         List<Map<String,Object>> arrayData=new LinkedList<>();
         String query="SELECT invoices.id, cmd.idfood,foods.namefood,foods.price,cmd.qte,invoices.dateInvoice FROM t_invoices as invoices join t_commands as cmd "+
